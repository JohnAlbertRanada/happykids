...
export default function AdminSentencePractice() {
  ...
  const AddItem = () => {
    return (
      <div className="rounded p-5 flex flex-col bg-white">
        <p className="text-2xl font-medium text-[#766A6A] mb-5">Add Sentence</p>
        <InputField
          label="Sentence"
          name="word"
          type="text"
  ...
  const EditItem = () => {
    return (
      <div className="rounded p-5 flex flex-col bg-white">
        <p className="text-2xl font-medium text-[#766A6A] mb-5">Edit Sentence</p>
        <InputField
          label="Sentence"
          name="word"
          type="text"
